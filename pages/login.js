...
const Login = () => {
  ...
  return (
        ...
        <Noise />
        <div
        className="bg-[#0f0f0f] text-white p-12 rounded-lg shadow-lg w-full max-w-lg border border-goldenTransparent relative z-50"
      ...
      >
        ...
        <div className="flex items-center justify-center my-6">
          ...
          <span id="loginSeparator"className="mx-3 text-400 text-3xl font-medium px-3 font-[balboa]">OR</span>
          <hr className="w-[45%] border-500 transition-all duration-300 ease-in-out hover:border-[#EDB900]" />
        </div>
        <button
