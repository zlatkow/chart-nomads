...
import { DollarSign, Users, TrendingUp, BarChart2, LoaderCircle, Gem, Banknote } from "lucide-react" // ✅ Added Loader icon
...
const IndustryStatsSlider = ({ statsData }) => {
  ...
  useEffect(() => {
    if (!statsData) {
      ...
      setTimeout(() => setLoading(false), 4000) // ✅ Simulate loading for smoother UI
    }
  }, [statsData])
