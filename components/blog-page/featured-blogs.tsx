...
// Original FeaturedBlogs component
export function FeaturedBlogs({ article }: FeaturedBlogsProps) {
  ...
  return (
    <Link href={`/blog/${formattedSlug}`} className="block group">
...
// New slider component that uses FeaturedBlogs
interface FeaturedBlogsSliderProps {
  articles: FeaturedArticle[]
  autoPlayInterval?: number
}

export function FeaturedBlogsSlider({ 
  articles, 
  autoPlayInterval = 5000 
}: FeaturedBlogsSliderProps) {
  ...
  return (
    <div className="relative">
      {/* Current slide */}
      {articles.length > 0 && (
        <FeaturedBlogs article={articles[currentSlide]} />
      )}
